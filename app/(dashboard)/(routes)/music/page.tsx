    ...
    return (
        <div>
            <Heading 
                ...
                description="Generate music with your custom prompts."
                icon={ Music }
            ...
            <div className="px-4 lg:px-8">
                                    ...
                                    lg:col-span-10">
                                        <FormControl className="m-0 p-0">
                                            <Input
                                                ...
                                                disabled={isLoading}
                                                placeholder="Guitar solo with a St.Anger-like drum fill"
                                                {...field}
                                            />
                                        </FormControl>
                                    </FormItem>
                ...
                <div className="space-y-4 mt-4">
                    ...
                    {music && (
                        <audio controls className="text-white w-full mt-8">
                            <source src={music}/>
                        </audio>
                    )}
                </div>
